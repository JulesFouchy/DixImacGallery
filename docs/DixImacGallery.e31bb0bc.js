...
},{}],"src/actions/test.js":[function(require,module,exports) {
"use strict";
...
exports.app = app;
},{}],"src/components/author.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(props) {
  ...
  return (0, _hyperapp.h)('div', {
    ...
    class: 'name'
  }, props.name), (0, _hyperapp.h)('a', {
    href: props.link
  }, props.link)]);
};

exports.default = _default;
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"src/components/cardStandalone.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(props) {
  return (0, _hyperapp.h)('div', {
    ...
    src: props.src
  }), (0, _author.default)(props.author)]);
};

exports.default = _default;
},{"hyperapp":"node_modules/hyperapp/src/index.js","./author":"src/components/author.js"}],"src/view/header.ts":[function(require,module,exports) {
"use strict";
...
exports.default = function () {
  return hyperapp_1.h('header', {}, [hyperapp_1.h('h1', {}, 'DixImac Gallery'), hyperapp_1.h('a', {
    href: 'http://diximac.herokuapp.com/'
  }, 'http://diximac.herokuapp.com/')]);
};
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"src/view/view.ts":[function(require,module,exports) {
"use strict";
...
var cardStandalone_1 = __importDefault(require("../components/cardStandalone"));

var header_1 = __importDefault(require("./header"));

exports.default = function (state) {
  return hyperapp_1.h('div', {}, [header_1.default(), cardStandalone_1.default({
...
},{"hyperapp":"node_modules/hyperapp/src/index.js","../components/cardStandalone":"src/components/cardStandalone.js","./header":"src/view/header.ts"}],"lib/hyperappLogger.js":[function(require,module,exports) {
"use strict";
...
var logger = function logger(bEnabled) {
  var output = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : console.debug;
  return bEnabled && function (dispatch) {
    return function (action, props, obj) {
      if (isFunction(action)) output('Action', action.name, props, obj);else if (isArray(action)) {
...
var _state = require("./src/state.ts");

var _test = _interopRequireDefault(require("./src/actions/test.js"));

var _view = _interopRequireDefault(require("./src/view/view.ts"));

var _hyperapp = require("hyperapp");

var _hyperappLogger = _interopRequireDefault(require("./lib/hyperappLogger"));
...
(0, _hyperapp.app)({
  ...
  view: _view.default,
  node: document.body
}, (0, _hyperappLogger.default)("development" === 'development'));
},{"./src/state.ts":"src/state.ts","./src/actions/test.js":"src/actions/test.js","./src/view/view.ts":"src/view/view.ts","hyperapp":"node_modules/hyperapp/src/index.js","./lib/hyperappLogger":"lib/hyperappLogger.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/DixImacGallery.e31bb0bc.js.map